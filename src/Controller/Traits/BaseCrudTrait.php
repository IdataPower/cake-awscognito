   ...
   public function edit($id = null)
    ...
    public function delete($id = null)
    {
        ...
        if ($this->ApiUsers->delete($api_user)) {
            $this->Flash->success(__d('PowerSystem/CognitoSDK', 'The Api User has been deleted'));
        } else {
            $this->Flash->error(__d('PowerSystem/CognitoSDK', 'The Api User could not be deleted'));
        }
