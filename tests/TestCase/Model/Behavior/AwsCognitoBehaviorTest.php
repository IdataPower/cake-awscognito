<?php
namespace PowerSystem\CognitoSDK\Test\TestCase\Model\Behavior;

use Aws\CognitoIdentityProvider\CognitoIdentityProviderClient;
use PowerSystem\CognitoSDK\Model\Behavior\AwsCognitoBehavior;
...
class AwsCognitoBehaviorTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        parent::setUp();
        $this->table = TableRegistry::get('PowerSystem/CognitoSDK.ApiUsers');
    ...
    public function testChangeEmailFailMissingUsername()
    {
        ...
        $this->expectExceptionMessage(__d('PowerSystem/CognitoSDK', 'The user does not have a Cognito Username.'));
        $this->Behavior->changeEmail($entity, $new_email, $require_verification);
    }
    ...
    public function testGetWithCognitoDataSuccess()
    {
        ...
        $this->assertEquals([
            'code'        => 'CONFIRMED',
            'title'       => __d('PowerSystem/CognitoSDK', 'Confirmed'),
            'description' => __d('PowerSystem/CognitoSDK', 'The user account is confirmed and the user can sign in.'),
