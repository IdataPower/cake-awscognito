<?php
namespace PowerSystem\CognitoSDK\Test\TestCase\Controller\Api;

use PowerSystem\CognitoSDK\Controller\Api\ApiUsersController;
...
class ApiUsersControllerTest extends IntegrationTestCase
{
    ...
    public function setUp()
    {
        ...
        Configure::write('Error', [
            'errorLevel' => E_ALL,
            'exceptionRenderer' => 'PowerSystem\ApiGatewaySDK\Error\ApiExceptionRenderer',
            'skipLog' => [],
            'log' => true,
            'trace' => true,
        ]);
